...
const UseHandicaps = 2;   // set to: 0 to disable handicapping, 1 to use handicaps, 2 is auto (handicaps only for club and multi-seat)
      UsePEV = True;        // Use PilotEventMarker start procedure
      PEVWaitTime = 300;    // Time to wait before start is allowed after pressing the PEV marker (value is in seconds)
      PEVStartWindow = 480; // Start gate is open for 8 minutes after pressing the PEV marker (value is in seconds)
